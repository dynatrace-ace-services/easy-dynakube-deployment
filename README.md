...
(tested with Azure VM Standard D2s v3 - 2 vCP, 8 GB)  
    ...
    while [[ `kubectl get pods -n easytravel | grep easytravel_www | grep "0/"` ]];do kubectl get pods -n easytravel;echo "==> waiting for easytravel_www pod ready";sleep 1; done
